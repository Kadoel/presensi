...
<head>
    ...
    <title>Error 404 | Antrian SKANADA</title>
    ...
    <!-- Open Graph Meta -->
    <meta property="og:title" content="Error 404 | FIREBASE">
                ...
                <div class="hero-inner">
                    <div class="content content-full">
                        <div class="py-4 text-center">
                            ...
                            <h1 class="fw-bold mt-5 mb-2">Oops... Maaf Gaaaeess</h1>
                            <h2 class="fs-4 fw-medium text-muted mb-5">Halaman Yang Anda Tuju Tidak Ada!</h2>
                            <a class="btn btn-lg btn-alt-secondary" href="<?= base_url(); ?>">
