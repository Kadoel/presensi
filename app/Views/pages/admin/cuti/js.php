...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#form_tambah_pengajuan').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url('admin/cuti/simpan') ?>',
                dataType: 'JSON',
                cache: false,
                contentType: false,
                processData: false,
        ...
        function tutup_modal() {
            ...
            $('#edit-jenis').val('cuti').trigger('change');
        ...
        $('#form_edit_pengajuan').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url('admin/cuti/update') ?>/' + id,
                dataType: 'JSON',
                cache: false,
                contentType: false,
                processData: false,
        ...
        $('#pengajuan-izin-tabel').on('click', '#act-delete', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?= base_url('admin/cuti/delete') ?>',
                        dataType: 'JSON',
                        data: {
                            [csrfToken]: csrfHash,
                            id: id
        ...
        $('#pengajuan-izin-tabel').on('click', '#act-approve', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?= base_url('admin/cuti/approve') ?>',
                        dataType: 'JSON',
                        data: {
                            [csrfToken]: csrfHash,
                            id: id,
        ...
        $('#pengajuan-izin-tabel').on('click', '#act-reject', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?= base_url('admin/cuti/reject') ?>',
                        dataType: 'JSON',
                        data: {
                            [csrfToken]: csrfHash,
                            id: id,
        ...
        $('#pengajuan-izin-tabel').on('click', '#act-cancel-approve', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?= base_url('admin/cuti/cancel-approve') ?>',
                        dataType: 'JSON',
                        data: {
                            [csrfToken]: csrfHash,
                            id: id
