...
<div class="row">
    <div class="col-md-4">
        <div class="alert alert-info">
            <b>Saldo Cuti Tahun <?= date('Y'); ?></b><br>
            <?php if ($saldo): ?>
                Jatah: <?= (int) $saldo->jatah; ?> hari |
                Terpakai: <?= (int) $saldo->terpakai; ?> hari |
                Sisa: <b><?= (int) $saldo->sisa; ?> hari</b>
            <?php else: ?>
                Saldo cuti belum tersedia. Hubungi admin.
            <?php endif; ?>
        </div>
        ...
        <div id="block-konten-tambah" class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title">
                    <i class="fa fa-calendar-days"></i> <b>TAMBAH PENGAJUAN CUTI</b>
                </h3>
            </div>
            ...
            <form id="form_tambah_pengajuan" autocomplete="off" enctype="multipart/form-data">
                <div class="block-content block-content-full">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" class="form-control" id="tanggal_mulai" name="tanggal_mulai" min="<?= $minTanggal; ?>" autocomplete="off">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" class="form-control" id="tanggal_selesai" name="tanggal_selesai" min="<?= $minTanggal; ?>" autocomplete="off">
    ...
    <div class="col-md-8">
        <div id="block-tabel" class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title">
                    <i class="fa fa-file-lines"></i> <b>DATA CUTI SAYA</b>
                </h3>
            </div>

            <div class="block-content block-content-full">
                <div class="table-responsive" style="overflow-x: auto;">
                    <table id="pengajuan-cuti-tabel" class="table table-vcenter table-hover nowrap" style="width:100%;">
                        <thead>
                            <tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div id="block-content-ubah" class="block block-rounded shadow-none mb-0">
                <div class="block-header block-header-default">
                    <h3 class="block-title">
                        <i class="fa fa-pen-to-square"></i> <b>UBAH PENGAJUAN CUTI</b>
                    </h3>
                </div>
                ...
                <form id="form_edit_pengajuan" autocomplete="off" enctype="multipart/form-data">
                    <div class="block-content">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" class="form-control" id="edit-tanggal_mulai" name="edit-tanggal_mulai" min="<?= $minTanggal; ?>" autocomplete="off">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" class="form-control" id="edit-tanggal_selesai" name="edit-tanggal_selesai" min="<?= $minTanggal; ?>" autocomplete="off">
